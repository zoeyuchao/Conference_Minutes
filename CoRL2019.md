...
内容：主要是用强化学习来做机器人的控制，他们组实际上很早就开始做机器人控制（比如185年的learn to walk和2001年的learn to stand up，以及他的学生Pavvo Parmas用强化学习做自平衡车 learn to Bounce up and balance，感觉他们的工作都是在线学习，用TD Error直接做的），他总结了一个model-based和model-free RL的区别，我觉得可以看看：
