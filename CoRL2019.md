...
内容：[照片和视频](https://github.com/zoeyuchao/Conference_Minutes/tree/master/figure/CoRL2019/kenji)

主要是用强化学习来做机器人的控制，他们组实际上很早就开始做机器人控制（比如185年的learn to walk和2001年的learn to stand up，以及他的学生用强化学习做自平衡车，感觉他们的工作都是在线学习，用TD Error直接做的），还在研究强化学习和脑结构的一些关系，1999年发表了文章，说每一个脑结构都完成了特殊的功能，比如监督学习，强化学习和无监督学习，看起来是在小鼠和猴子身上做实验。最后提出了自动化AI的danger：
<div align=center>
